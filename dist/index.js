...
(() => {
  var t = {
    ...
    686: (t, e, s) => {
      ...
      function refreshSupervisor() {
        ...
        i.forEach(e => {
          ...
          const i = `docker run --rm --name ${s} ${e}`;
          t.set(s, i);
        });
    ...
    740: (t, e, s) => {
      ...
      t.exports.buildImage = async function (t) {
        const e = r(t);
        return i.execAsync(`docker build -t ${e} ${t}`);
      };
    },
    664: (t, e, s) => {
      const i = s(896);
    ...
    127: (t, e, s) => {
      ...
      function combineOptions(t) {
        return { stdio: 'inherit', shell: true, ...t };
      }
      function execSync(t, e = {}) {
        testCommand(t);
        try {
          return i.execSync(t, combineOptions(e));
        } catch (e) {
          console.error(`Error executing command: ${t}`, e);
          throw e;
        }
      }
      function execAsync(t, e = {}) {
        testCommand(t);
        const [s, ...r] = t.split(' ');
        return new Promise((n, o) => {
          const a = i.spawn(s, r, combineOptions(e));
          a.on('close', t => {
            if (t === 0) {
              n();
            } else {
              o(new Error(`Command failed with exit code ${t}`));
            }
          });
          a.on('error', e => {
            console.error(`Failed to start command: ${t}`, e);
            o(e);
          });
        });
      }
      t.exports = { execSync: execSync, execAsync: execAsync };
    },
    494: t => {
      class UniqueQueue {
